...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TrivyVersion) DeepCopyInto(out *TrivyVersion) {
	*out = *in
	in.VulnerabilityDB.DeepCopyInto(&out.VulnerabilityDB)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TrivyVersion.
func (in *TrivyVersion) DeepCopy() *TrivyVersion {
	if in == nil {
		return nil
	}
	out := new(TrivyVersion)
	in.DeepCopyInto(out)
	return out
}
