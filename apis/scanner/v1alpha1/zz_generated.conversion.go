...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*CVSSScore)(nil), (*scanner.CVSSScore)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_CVSSScore_To_scanner_CVSSScore(a.(*CVSSScore), b.(*scanner.CVSSScore), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*scanner.CVSSScore)(nil), (*CVSSScore)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_scanner_CVSSScore_To_v1alpha1_CVSSScore(a.(*scanner.CVSSScore), b.(*CVSSScore), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_CVSS_To_scanner_CVSS(in *CVSS, out *scanner.CVSS, s conversion.Scope) error {
	out.Nvd = (*scanner.CVSSScore)(unsafe.Pointer(in.Nvd))
	out.Redhat = (*scanner.CVSSScore)(unsafe.Pointer(in.Redhat))
	return nil
}
...
func autoConvert_scanner_CVSS_To_v1alpha1_CVSS(in *scanner.CVSS, out *CVSS, s conversion.Scope) error {
	out.Nvd = (*CVSSScore)(unsafe.Pointer(in.Nvd))
	out.Redhat = (*CVSSScore)(unsafe.Pointer(in.Redhat))
	return nil
}
...
func autoConvert_v1alpha1_CVSSScore_To_scanner_CVSSScore(in *CVSSScore, out *scanner.CVSSScore, s conversion.Scope) error {
...
// Convert_v1alpha1_CVSSScore_To_scanner_CVSSScore is an autogenerated conversion function.
func Convert_v1alpha1_CVSSScore_To_scanner_CVSSScore(in *CVSSScore, out *scanner.CVSSScore, s conversion.Scope) error {
	return autoConvert_v1alpha1_CVSSScore_To_scanner_CVSSScore(in, out, s)
}

func autoConvert_scanner_CVSSScore_To_v1alpha1_CVSSScore(in *scanner.CVSSScore, out *CVSSScore, s conversion.Scope) error {
	out.V2Vector = in.V2Vector
	out.V3Vector = in.V3Vector
	out.V2Score = in.V2Score
	out.V3Score = in.V3Score
...
// Convert_scanner_CVSSScore_To_v1alpha1_CVSSScore is an autogenerated conversion function.
func Convert_scanner_CVSSScore_To_v1alpha1_CVSSScore(in *scanner.CVSSScore, out *CVSSScore, s conversion.Scope) error {
	return autoConvert_scanner_CVSSScore_To_v1alpha1_CVSSScore(in, out, s)
}
