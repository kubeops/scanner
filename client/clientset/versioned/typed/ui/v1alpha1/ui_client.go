...
// UiV1alpha1Client is used to interact with features provided by the ui.scanner.appscode.com group.
type UiV1alpha1Client struct {
	restClient rest.Interface
}

func (c *UiV1alpha1Client) Reports(namespace string) ReportInterface {
