...
// strategy implements verification logic for ImageScanReports.
...
// NamespaceScoped returns true because all ImageScanReports need to be within a namespace.
...
func (strategy) PrepareForCreate(ctx context.Context, obj runtime.Object) {
	controller := obj.(*api.ImageScanReport)
	controller.Status = api.ImageScanReportStatus{}
...
func (strategy) PrepareForUpdate(ctx context.Context, obj, old runtime.Object) {
	newController := obj.(*api.ImageScanReport)
	oldController := old.(*api.ImageScanReport)
...
func (statusStrategy) PrepareForUpdate(ctx context.Context, obj, old runtime.Object) {
	newRc := obj.(*api.ImageScanReport)
	oldRc := old.(*api.ImageScanReport)
